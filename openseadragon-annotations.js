...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _controls = __webpack_require__(/*! ./controls */ 23);
	...
	_OpenSeadragon2.default.Viewer.prototype.initializeAnnotations = function initialize(cb) {
	  var _this = this;
	...
	_OpenSeadragon2.default.Viewer.prototype.areAnnotationsActive = function isActive() {
	...
	_OpenSeadragon2.default.Viewer.prototype.shutdownAnnotations = ifPluginIsActive(function shutdown() {
	  ...
	  (0, _actions.selectMode)(_modes2.default.MOVE);
...
/***/ (function(module, exports, __webpack_require__) {
	    ...
	    value: function render() {
	      ...
	      return (0, _preact.h)(
	        ...
	        _extends({}, svgProperties, {
	          ...
	          onMouseDown: unlessInMoveMode(function (e) {
	            return _actions.press.apply(undefined, _toConsumableArray(_this3.coords(e)));
	          }),
	          onMouseLeave: unlessInMoveMode(_actions.leaveCanvas),
	          onMouseMove: unlessInMoveMode(function (e) {
	            return _actions.move.apply(undefined, _toConsumableArray(_this3.coords(e)));
	          }),
	          onMouseUp: unlessInMoveMode(_actions.release)
	        }),
	...
	function unlessInMoveMode(fn) {
	  return function (e) {
	    if (_Store2.default.getMode() !== _modes2.default.MOVE) {
	      e.stopPropagation();
	      fn(e);
	    }
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	_Dispatcher2.default.register(function (action) {
	  switch (action.type) {
	    case _actionTypes2.default.MODE_UPDATE:
	      data.mode = action.mode;
	      break;

	    case _actionTypes2.default.ACTIVITY_UPDATE:
	      data.activityInProgress = action.inProgress;
	      break;

	    case _actionTypes2.default.ANNOTATIONS_CREATE:
	      data.annotations.push(action.annotation);
	      break;

	    case _actionTypes2.default.ANNOTATIONS_UPDATE_LAST:
	      (0, _OpenSeadragon.extend)(Store.getLast()[1], action.update);
	      break;

	    case _actionTypes2.default.ANNOTATIONS_RESET:
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.selectMode = exports.release = exports.press = exports.move = exports.leaveCanvas = exports.fillCanvasWith = exports.cleanCanvas = undefined;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function cleanCanvas(Dispatcher) {
	  Dispatcher.dispatch({
	    type: _actionTypes2.default.ACTIVITY_UPDATE,
	    inProgress: false
	  });
	  Dispatcher.dispatch({
	    type: _actionTypes2.default.ANNOTATIONS_RESET,
	    annotations: []
	  });
	}
	    ...
	    case _modes2.default.DRAW:
	      if (Store.isActivityInProgress()) {
	        ...
	        if (last && last[0] === 'path') {
	          var d = last[1].d;
	          Dispatcher.dispatch({
	            type: _actionTypes2.default.ANNOTATIONS_UPDATE_LAST,
	            update: { d: d + ' L' + x + ' ' + y }
	          });
	        }
	      }
	...
	function press(Dispatcher, Store, x, y) {
	  switch (Store.getMode()) {
	    ...
	    case _modes2.default.DRAW:
	      ...
	      Dispatcher.dispatch({
	        type: _actionTypes2.default.ANNOTATIONS_CREATE,
	...
	var shapesFactory = {
	  getPath: function getPath(x, y) {
	    return ['path', {
	      ...
	      'stroke-height': _graphical.STROKE_SIZE,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function selectMode(Dispatcher, Store, mode) {
	  ...
	  if (Store.getMode() !== mode) {
	    Dispatcher.dispatch({
	      type: _actionTypes2.default.MODE_UPDATE,
	      mode: mode
	    });
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Draw = __webpack_require__(/*! ./Draw */ 30);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Control2 = __webpack_require__(/*! ./Control */ 25);

	var _Control3 = _interopRequireDefault(_Control2);

	var _move_grouphover = __webpack_require__(/*! ../../img/move_grouphover.png */ 26);

	var _move_grouphover2 = _interopRequireDefault(_move_grouphover);

	var _move_hover = __webpack_require__(/*! ../../img/move_hover.png */ 27);

	var _move_hover2 = _interopRequireDefault(_move_hover);

	var _move_pressed = __webpack_require__(/*! ../../img/move_pressed.png */ 28);

	var _move_pressed2 = _interopRequireDefault(_move_pressed);

	var _move_rest = __webpack_require__(/*! ../../img/move_rest.png */ 29);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _draw_grouphover = __webpack_require__(/*! ../../img/draw_grouphover.png */ 31);

	var _draw_grouphover2 = _interopRequireDefault(_draw_grouphover);

	var _draw_hover = __webpack_require__(/*! ../../img/draw_hover.png */ 32);

	var _draw_hover2 = _interopRequireDefault(_draw_hover);

	var _draw_pressed = __webpack_require__(/*! ../../img/draw_pressed.png */ 33);

	var _draw_pressed2 = _interopRequireDefault(_draw_pressed);

	var _draw_rest = __webpack_require__(/*! ../../img/draw_rest.png */ 34);
