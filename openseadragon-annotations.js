...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _controls = __webpack_require__(/*! ./controls */ 26);
	...
	_OpenSeadragon2.default.Viewer.prototype.shutdownAnnotations = ifPluginIsActive(function shutdown() {
	  ...
	  (0, _actions.selectMode)(_modes.MOVE);
	  (0, _actions.cleanCanvas)();
	...
	var set = ifPluginIsActive(function (annotations) {
	  (0, _actions.fillCanvasWith)(annotations);
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _graphical = __webpack_require__(/*! ../constants/graphical */ 20);

	var _convert = __webpack_require__(/*! ../utils/convert */ 25);
	    ...
	    return (0, _preact.h)(
	      ...
	      _extends({}, svgProperties, {
	        ...
	        onMouseDown: function onMouseDown(e) {
	          if (_Store2.default.getMode() !== _modes.MOVE) {
	            e.stopPropagation();
	            _actions.press.apply(undefined, _this3.coords(e));
	          }
	        },
	        ...
	        onMouseLeave: function onMouseLeave(e) {
	          if (_Store2.default.getMode() !== _modes.MOVE) {
	            e.stopPropagation();
	            (0, _actions.leaveCanvas)();
	          }
	        },
	        onMouseMove: function onMouseMove(e) {
	          if (_Store2.default.getMode() !== _modes.MOVE) {
	            e.stopPropagation();
	            _actions.move.apply(undefined, _this3.coords(e));
	          }
	        },
	      ...
	      this.state.annotations.map(function (el) {
	        el[1]['stroke-width'] = _convert.convertWidth.toPercent(_graphical.STROKE_SIZE);
...
/***/ (function(module, exports) {
	...
	var ACTIVITY_UPDATE = 'ACTIVITY_UPDATE';
	var ANNOTATIONS_CREATE = 'ANNOTATIONS_CREATE';
	var ANNOTATIONS_UPDATE_LAST = 'ANNOTATIONS_UPDATE_LAST';
	var ANNOTATIONS_RESET = 'ANNOTATIONS_RESET';
	var ZOOM_UPDATE = 'ZOOM_UPDATE';
	var INITIALIZE = 'INITIALIZE';

	exports.MODE_UPDATE = MODE_UPDATE;
	exports.ACTIVITY_UPDATE = ACTIVITY_UPDATE;
	exports.ANNOTATIONS_CREATE = ANNOTATIONS_CREATE;
	exports.ANNOTATIONS_UPDATE_LAST = ANNOTATIONS_UPDATE_LAST;
	exports.ANNOTATIONS_RESET = ANNOTATIONS_RESET;
	exports.ZOOM_UPDATE = ZOOM_UPDATE;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.initialize = exports.zoom = exports.selectMode = exports.release = exports.press = exports.move = exports.leaveCanvas = exports.fillCanvasWith = exports.cleanCanvas = undefined;
	...
	var _cleanCanvas = __webpack_require__(/*! ./cleanCanvas */ 14);

	var _cleanCanvas2 = _interopRequireDefault(_cleanCanvas);

	var _fillCanvasWith = __webpack_require__(/*! ./fillCanvasWith */ 15);

	var _fillCanvasWith2 = _interopRequireDefault(_fillCanvasWith);

	var _leaveCanvas = __webpack_require__(/*! ./leaveCanvas */ 16);

	var _leaveCanvas2 = _interopRequireDefault(_leaveCanvas);

	var _move = __webpack_require__(/*! ./move */ 17);

	var _move2 = _interopRequireDefault(_move);

	var _press = __webpack_require__(/*! ./press */ 18);

	var _press2 = _interopRequireDefault(_press);

	var _release = __webpack_require__(/*! ./release */ 21);

	var _release2 = _interopRequireDefault(_release);

	var _selectMode = __webpack_require__(/*! ./selectMode */ 22);

	var _selectMode2 = _interopRequireDefault(_selectMode);

	var _zoom = __webpack_require__(/*! ./zoom */ 23);

	var _zoom2 = _interopRequireDefault(_zoom);

	var _initialize = __webpack_require__(/*! ./initialize */ 24);

	var _initialize2 = _interopRequireDefault(_initialize);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var bindedCleanCanvas = _cleanCanvas2.default.bind(null, _Dispatcher2.default);
	var bindedFillCanvasWith = _fillCanvasWith2.default.bind(null, _Dispatcher2.default);
	var bindedLeaveCanvas = _leaveCanvas2.default.bind(null, _Dispatcher2.default, _Store2.default);
	var bindedMove = _move2.default.bind(null, _Dispatcher2.default, _Store2.default);
	var bindedPress = _press2.default.bind(null, _Dispatcher2.default, _Store2.default);
	var bindedRelease = _release2.default.bind(null, _Dispatcher2.default, _Store2.default);
	var bindedSelectMode = _selectMode2.default.bind(null, _Dispatcher2.default, _Store2.default);
	var bindedZoom = _zoom2.default.bind(null, _Dispatcher2.default, _Store2.default);
	var bindedInitialize = _initialize2.default.bind(null, _Dispatcher2.default, _Store2.default);

	exports.cleanCanvas = bindedCleanCanvas;
	exports.fillCanvasWith = bindedFillCanvasWith;
	exports.leaveCanvas = bindedLeaveCanvas;
	exports.move = bindedMove;
	exports.press = bindedPress;
	exports.release = bindedRelease;
	exports.selectMode = bindedSelectMode;
	exports.zoom = bindedZoom;
	exports.initialize = bindedInitialize;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function fillCanvasWith(Dispatcher, annotations) {
	  Dispatcher.dispatch({
	    type: _actionTypes.ACTIVITY_UPDATE,
	    inProgress: false
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function move(Dispatcher, Store, x, y) {
	  switch (Store.getMode()) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _shapesFactory = __webpack_require__(/*! ../utils/shapesFactory */ 19);

	var _shapesFactory2 = _interopRequireDefault(_shapesFactory);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function press(Dispatcher, Store, x, y) {
	  switch (Store.getMode()) {
...
/***/ (function(module, exports) {
	...
	exports.STROKE_COLOR = STROKE_COLOR;
	exports.STROKE_SIZE = STROKE_SIZE;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function selectMode(Dispatcher, Store, mode) {
	  Dispatcher.dispatch({
	    type: _actionTypes.ACTIVITY_UPDATE,
	    inProgress: false
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function selectMode(Dispatcher, Store, zoom) {
	  Dispatcher.dispatch({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function leaveCanvas(Dispatcher, Store, options) {
	  Dispatcher.dispatch({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Move = __webpack_require__(/*! ./Move */ 27);

	var _Move2 = _interopRequireDefault(_Move);

	var _Draw = __webpack_require__(/*! ./Draw */ 33);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Control2 = __webpack_require__(/*! ./Control */ 28);

	var _Control3 = _interopRequireDefault(_Control2);

	var _move_grouphover = __webpack_require__(/*! ../../img/move_grouphover.png */ 29);

	var _move_grouphover2 = _interopRequireDefault(_move_grouphover);

	var _move_hover = __webpack_require__(/*! ../../img/move_hover.png */ 30);

	var _move_hover2 = _interopRequireDefault(_move_hover);

	var _move_pressed = __webpack_require__(/*! ../../img/move_pressed.png */ 31);

	var _move_pressed2 = _interopRequireDefault(_move_pressed);

	var _move_rest = __webpack_require__(/*! ../../img/move_rest.png */ 32);
	...
	var Control = function () {
	  ...
	  Control.prototype.onClick = function onClick(e) {
	    if (e.eventSource.Tooltip) {
	      (0, _actions.selectMode)(e.eventSource.Tooltip.toUpperCase());
	    }
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _draw_grouphover = __webpack_require__(/*! ../../img/draw_grouphover.png */ 34);

	var _draw_grouphover2 = _interopRequireDefault(_draw_grouphover);

	var _draw_hover = __webpack_require__(/*! ../../img/draw_hover.png */ 35);

	var _draw_hover2 = _interopRequireDefault(_draw_hover);

	var _draw_pressed = __webpack_require__(/*! ../../img/draw_pressed.png */ 36);

	var _draw_pressed2 = _interopRequireDefault(_draw_pressed);

	var _draw_rest = __webpack_require__(/*! ../../img/draw_rest.png */ 37);
